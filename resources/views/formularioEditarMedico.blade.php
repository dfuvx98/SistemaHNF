                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('medico.update', $medico) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cedula" type="text" class="form-control" @error('cedula') is-invalid @enderror name="cedula" value="{{ $medico->cedula}}" required autocomplete="cedula" autofocus readonly>
                                @error('cedula')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
